...
//  ## Dialog ########## ########## ########## ########## ##########
//
class ClientGroupMultiSelector extends Component {
    ...
    render() {
        ...
        const dialogType = ClientGroupMultiSelector.TYPE_ADD;
        ...
        let title = "";
        if(dialogType === ClientGroupMultiSelector.TYPE_ADD) {
            title = t("dtAddAdminUser");
        } else if(dialogType === ClientGroupMultiSelector.TYPE_VIEW) {
            title = t("dtViewAdminUser");
        } else if(dialogType === ClientGroupMultiSelector.TYPE_EDIT) {
        ...
        return (
            ...
            <ValidatorForm ref="form">
                    ...
                    <Grid container spacing={0} style={{marginTop:10}}>
                        <Grid item xs={6} style={{paddingRight:5}}>
                            ...
                            <TextValidator
                                ...
                                disabled={(dialogType == ClientGroupMultiSelector.TYPE_EDIT) ? true : false}
                            />
                            <TextValidator
                ...
                <DialogActions>
                {(dialogType === ClientGroupMultiSelector.TYPE_ADD) &&
                    <Button onClick={this.handleCreateData} variant='contained' color="secondary">{t("btnRegist")}</Button>
                }
                {(dialogType === ClientGroupMultiSelector.TYPE_EDIT) &&
...
export default translate("translations")(connect(mapStateToProps, mapDispatchToProps)(withStyles(GRCommonStyle)(ClientGroupMultiSelector)));
