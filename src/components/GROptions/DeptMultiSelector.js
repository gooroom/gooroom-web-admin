...
class DeptMultiSelector extends Component {
    ...
    render() {
        ...
        const { title, selectedDept, isCheckMasterOnly } = this.props;
...
export default translate("translations")(withStyles(GRCommonStyle)(DeptMultiSelector));
