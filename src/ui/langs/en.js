export default {
  ...
  "spCleanModeSupport": "Clean mode support",
  ...
  "spCleanModeRun": "Whether to allow clean mode",
  ...
  // 작업관리 - 작업이름
  "lbHostFileChg": "Change Host File",
  "lbPwdCycleSet": "Set Password Change Cycle",
  "lbScreenSaverTimeSet": "Set Screen Saver Time",
  "lbMediaRuleConf": "Set Media Control Policy",
  "lbBrowserRuleConf": "Set Browser Policy",
  "lbUpdateOprSet": "Set Add/Remove Package Blocking Function",
  "lbSoftwareRestrictionPolicy": "Set Software Control Policy",
  "lbLogConfChg": "Change Log Config",
  "lbCtrlCenterItems": "Set Control Center Item Policy",
  "lbPolicyKitConf": "Set PolicyKit Policy",
  "lbAccountConf": "Set root Accout / sudo authority",
  "lbPolkyAdminConf": "Set Polkit Admin",
  "lbNotice": "Notice",
  "lbMultiLoginMsg": "Multiple Login Notification",
  "lbInstallOrUpgradePackage": "Install Or Upgrade Package",
  "lbRemovePackage": "Remove Package",
  ...
  "dtCleanMode": "CleanMode",
  "lbPolicykitUserMng": "Policykit Admin",
  "lbPolicykitSudoGroup": "Sudo Group",
  "lbPolicykitLocalUser": "Local User",
  "dtRootAllow": "root Account",
  "dtSudoAllow": "sudo Role",
  ...
  "lbSetUserMediaRule": "User media control request setting",
  "msgSetUserMediaRuleRequest": "Determines the setting value for the user's media control request.",
  "lbSetLimitCnt": "Setting the maximum number of registrations",
  "lbHowToApproveReq": "How to approve registration requests",
  "lbHowToDeleteReq": "Deletion request approval method",
  "lbManual": "Manual",
  "lbAutomatic": "Automatic",
  "msgValidUserMediaRuleRequired": "Please enter the maximum number of registrations.",
  "msgValidUserMediaRuleMaximum": "The maximum number of registrations cannot be greater than 99.",
  "colReqSeq": "Sequence",
  "colReqType": "Request Type",
  "colReqUserId": "UserID",
  "colReqClientId": "Client ID",
  "colUsbName": "USB Name",
  "colUsbModel": "USB Model",
  ...
  "lbUsbNm": "USB Name",
  "lbUsbSerial": "USB Serial",
  "lbUsbProduct": "USB Product",
  "lbUsbVendor": "USB Vendor",
  "lbUsbModel": "USB Model",
  "btUsbAuthRecovery": "USB authorization recovery",
  "lbUsbAuthRecovery": "USB authorization recovery",
  "lbRegister": "Register",
  "lbUnregister": "Unregister",
  "lbApprove": "Approval",
  "lbDeny": "Companion",
  "lbRevokeAuth": "Deleted",
  "btnApprove": "Approval",
  "btnDeny": "Deny",
  "lbAdminCheckApprove": "Admin Approval",
  "lbAdminCheckDeny": "Admin Deny",
  "lbMediaRuleReqList": "USB Serial Accept List",
  "lbReqCnt": "Cnt",
  "msgApproveUserRequest": "Do you want to approve the {{checkedIds}} selected user requests?",
  "msgDenyUserRequest": "Would you like to decline the {{checkedIds}} selected user requests?",
  "msgUnregister": "Do you want to revoke the authority of the selected user media control request number '{{reqSeq}}'?",
  ...
  "btnInstantNotice": "Instant notice",
  ...
  "colNoticePublishInstantNoticeCnt": "Instant notice count",
  "colTargetType": "Target type",
  "colTargetName": "Target name",
  "lbActive": "Active",
  "lbInactive": "Inactive",
  "lbUnlimited": "Unlimited",
  "lbOnlyAlarm": "After click",
  "lbWithTitle": "Message immediately",
  ...
  "txPortableImageAborted": "Aborted",
