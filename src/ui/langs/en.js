export default {
  ...
  "msgDeptFromFileHelp04": "# If you do not enter a 'parent organization ID' of the parent organization, it will be included as a 'gooroom' organization child",
  "msgDeptFromFileHelp05": "# [Required] The 'parent organization ID' of the parent organization of the organization to be written is written as 'DEPTDEFAULT'.",
  "msgDeptFromFileHelp06": "# [Caution] All previously registered organization information will be deleted and registered.",
  ...
  "msgUserFromFileHelp03": "# Create a file on each line in the following order: 'User ID(Required)', 'User Name(Required)', 'Password(Required)', 'Organization ID(Required)', 'Email(Required)', 'Expiration Date(Optional)', 'Password Expiration Date(Optional)'. (7 items)",
  "msgUserFromFileHelp04": "# If you don't enter an organization ID, it will be included under 'gooroom'",
  "msgUserFromFileHelp05": "# The 'expiration date' format is 8 digits in order of 'year month date'. (E.g. '20191030')",
  "msgUserFromFileHelp06": "# 'Password' already set in the file received through the download cannot be changed.",
  "msgUserFromFileHelp06": "# The password of newly registered user is uploaded as 'blank' and is reset to 1.",
  "msgUserFromFileHelp08": "# [Caution] All previously registered user information is deleted and registered.",
