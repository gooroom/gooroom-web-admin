export default {
  ...
  "ttUpdateTotalPackgeInClient": "단말에 전체 패키지 업데이트",
  ...
  "dtAllPackageUpdate": "전체패키지 업데이트",
  "msgAllPackageUpdate": "선택하신 단말 또는 그룹에 업데이트 가능 패키지를 모두 업데이트 하겠습니까?",
  "msgTotalPackageUpdateForClient": "선택하신 단말에 업데이트 가능 패키지를 모두 업데이트 하겠습니까?",
  "msgTotalPackageUpdateForGroup": "선택하신 단말그룹에 업데이트 가능 패키지를 모두 업데이트 하겠습니까?",
  ...
  "msgPackageListUpdate": "패키지리스트를 업데이트 하겠습니까?",
  ...
  "lbLoginDuplicatgeNotiType1": "메일",
  "lbLoginDuplicatgeNotiType2": "알림",
  "lbLoginDuplicatgeNotiType3": "메일과 알림",
  "selHasInclude": "포함",
  "selHasNoInclude": "비포함",
  ...
  "btUploadTrustSetup": "파일을 이용하여 신뢰사이트 내용 등록",
  ...
  "selScreenCaptureOn": "스크린캡쳐 허가",
  "selScreenCaptureOff": "스크린캡쳐 금지",
  ...
  "colNoticePublishInstantNoticeCnt": "즉시 알림수",
  "colTargetType": "대상종류",
  "colTargetName": "대상이름",
  "lbActive": "활성",
  "lbInactive": "비활성",
  ...
  "msgDeptFromFileHelp04": "# '상위조직아이디'를 입력하지 않을 경우 '구름' 조직 하위로 포함됩니다.",
  "msgDeptFromFileHelp05": "# [필수] 작성하는 조직의 가장 상위조직의 '상위조직아이디' 는 'DEPTDEFAULT' 로 작성합니다.",
  "msgDeptFromFileHelp06": "# [주의] 이전에 등록되어 있는 전체 조직정보가 삭제되고 등록됩니다.",

  "msgUserFromFileHelp01": "# 사용자정보를 파일을 이용하여 등록할 수 있습니다.",
  "msgUserFromFileHelp02": "# 엑셀 형식(.xls / .xlsx)의 파일을 사용합니다.",
  "msgUserFromFileHelp03": "# 각 줄에 '사용자아이디(필수)','사용자이름(필수)','비밀번호(선택)','조직아이디(필수)','이메일(필수)','사용자만료일(선택)','패스워드만료일(선택)' 순서로 파일을 작성합니다. (7개 항목)",
  "msgUserFromFileHelp04": "# 조직아이디를 입력하지 않을 경우 '구름'조직 아래로 포함됩니다.",
  "msgUserFromFileHelp05": "# '만료일' 형식은 '년월일' 순서로 8자리로 작성합니다. (예: '20191030')",
  "msgUserFromFileHelp06": "# 사용자 정보 다운로드를 통해 받은 파일에 등록되어 있는 '패스워드'는 변경하지 않고 업로드합니다.",
  "msgUserFromFileHelp07": "# 새로 등록하는 사용자의 데이터 중 비밀번호는 '빈칸'으로 업로드하며, 1로 초기화됩니다.",
  "msgUserFromFileHelp08": "# [주의] 이전에 등록되어 있는 전체 사용자정보가 삭제되고 등록됩니다.",
