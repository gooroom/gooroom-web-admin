...
const COMMON_PENDING = 'siteManage/COMMON_PENDING';
const COMMON_FAILURE = 'siteManage/COMMON_FAILURE';

const GET_REGKEY_LISTPAGED_SUCCESS = 'siteManage/GET_REGKEY_LISTPAGED_SUCCESS';

const CREATE_REGKEY_SUCCESS = 'siteManage/CREATE_REGKEY_SUCCESS';

const EDIT_REGKEY_SUCCESS = 'siteManage/EDIT_REGKEY_SUCCESS';
const DELETE_REGKEY_SUCCESS = 'siteManage/DELETE_REGKEY_SUCCESS';

const CHG_LISTPARAM_DATA = 'siteManage/CHG_LISTPARAM_DATA';

const SHOW_REGKEY_DIALOG = 'siteManage/SHOW_REGKEY_DIALOG';
const CLOSE_REGKEY_DIALOG = 'siteManage/CLOSE_REGKEY_DIALOG';

const SET_EDITING_ITEM_VALUE = 'siteManage/SET_EDITING_ITEM_VALUE';
...
export const readClientRegkeyListPaged = (module, compId, extParam) => dispatch => {
    ...
    return requestPostAPI('readSiteMngListPaged', {
