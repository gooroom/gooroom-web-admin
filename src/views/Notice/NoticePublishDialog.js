                                    ...
                                    <Grid container spacing={16} direction="row" justify="flex-start" alignItems="center">
                                        <Grid item xs={5}>
                                            <InlineDateTimePicker label={t('colNoticePublishOpenDt')} format='YYYY-MM-DD HH:mm'
                                                minDate={formatDateToSimple(new Date(), 'YYYY-MM-DD HH:mm')}
                                                ...
                                                className={classes.fullWidth} disabled={editingItem.get('isInstantAlarm')}/>
                                        </Grid>
                                        <Grid item xs={5}>
                                            <InlineDateTimePicker label={t('colNoticePublishCloseDt')} format='YYYY-MM-DD HH:mm'
                                                ...
                                                className={classes.fullWidth} disabled={editingItem.get('isUnlimited')}/>
                                        </Grid>
                                        <Grid item xs={2}>
                                            <FormControlLabel
                                                control={
