...
class DailyProtectedSpec extends Component {
  ...
  render() {
    ...
    if(selectedItem) {
      viewItem = generateDailyProtectedObject(selectedItem, true);
...
export default withStyles(GRCommonStyle)(DailyProtectedSpec);

export const generateDailyProtectedObject = (param, isForViewer) => {
