...
class CtrlCenterItemDialog extends Component {
    ...
    static ITEM_LIST = [
        ...
        {no:6, tag:'universal-access', name:'universal-access', name_kr:'접근성'},
        {no:7, tag:'font', name:'font', name_kr:'글꼴'},
        {no:8, tag:'online-accounts', name:'online-accounts', name_kr:'온라인 계정'},
        {no:9, tag:'privacy', name:'privacy', name_kr:'개인 정보'},
        {no:10, tag:'sharing', name:'sharing', name_kr:'공유'},
        {no:11, tag:'sound', name:'sound', name_kr:'소리'},
        {no:12, tag:'power', name:'power', name_kr:'전원'},
        {no:13, tag:'network', name:'network', name_kr:'네트워크'},
        {no:14, tag:'wifi', name:'wifi', name_kr:'와이파이'},
        {no:15, tag:'wacom', name:'wacom', name_kr:'와콤'},
        {no:16, tag:'display', name:'display', name_kr:'디스플레이'},
        {no:17, tag:'keyboard', name:'keyboard', name_kr:'키보드'},
        {no:18, tag:'mouse', name:'mouse', name_kr:'마우스 및 터치패드'},
        {no:19, tag:'printers', name:'printers', name_kr:'프린터'},
        {no:20, tag:'removable-media', name:'removable-media', name_kr:'이동식 미디어'},
