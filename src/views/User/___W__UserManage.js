...
//  ## Content ########## ########## ########## ########## ########## 
//
class ___W__UserManage extends Component {
  ...
  render() {
    ...
    console.log('>>>>>>>>>>>> ', (listObj && listObj.get('listData')) ? listObj.get('listData').toJS() : '' );
...
<MUIDataTable
  title={"Employee List"}
  data={listObj.get('listData').toJS()}
  columns={columns}
  options={options}
/>
}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(GRCommonStyle)(___W__UserManage));
