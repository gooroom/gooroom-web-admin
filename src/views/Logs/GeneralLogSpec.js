...
class GeneralLogSpec extends Component {
  ...
  render() {
    ...
    if(selectedItem) {
      viewItem = generateGeneralLogObject(selectedItem, true);
...
export default withStyles(GRCommonStyle)(GeneralLogSpec);

export const generateGeneralLogObject = (param, isForViewer) => {
